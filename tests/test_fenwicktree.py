...
class TestFenwickTree:
    ...
    def test_add_when_negative_value_is_given(self, fenwicktree: FenwickTree) -> None:
        """
        fenwicktree.add(p, x) is expected to add x to the p-th of the number
        sequence.
    ...
    def test_add_when_positive_floating_point_value_is_given(self, fenwicktree: FenwickTree) -> None:
        """
        fenwicktree.add(p, x) is expected to add x to the p-th of the number
        sequence.
    ...
    def test_add_when_negative_floating_point_value_is_given(self, fenwicktree: FenwickTree) -> None:
        """
        fenwicktree.add(p, x) is expected to add x to the p-th of the number
        sequence.
    ...
    def test_sum(self, fenwicktree: FenwickTree, left: int, right: int, expected: int) -> None:
        """
    ...
    def test_add_failed_if_invalid_input_is_given(self, fenwicktree: FenwickTree, p: int) -> None:
        """
    ...
    def test_sum_failed_if_invalid_input_is_given(self, fenwicktree: FenwickTree, left: int, right: int) -> None:
        """
