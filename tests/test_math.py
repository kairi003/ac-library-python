...
class TestMath:
    ...
    @pytest.mark.parametrize(
        ("r", "m", "expected"),
        [
            ([44, 23, 13], [13, 50, 22], (1773, 7150)),
            ([12345, 67890, 99999], [13, 444321, 95318], (103333581255, 550573258014)),
            ([0, 3, 4], [1, 9, 5], (39, 45)),
            ([1, 2, 1], [2, 3, 2], (5, 6)),
            ([], [], (0, 1)),
        ],
    )
    def test_crt(self, r: list[int], m: list[int], expected: tuple[int, int]) -> None:
        """
            ...
            for m in range(1, value_max + 1):
                for a in range(value_max + 1):
                    for b in range(value_max + 1):
                        assert floor_sum(n, m, a, b) == self._floor_sum_naive(n, m, a, b)
    ...
    def test_floor_sum_using_acl_practice_contest(self, n: int, m: int, a: int, b: int, expected: int) -> None:
        """
    ...
    def test_inv_mod_failed_if_invalid_input_is_given(self, a: int, b: int) -> None:
        """
    ...
    def test_crt_failed_if_invalid_input_is_given(self, r: list[int], m: list[int]) -> None:
        """
    ...
    def test_floor_sum_failed_if_invalid_input_is_given(self, n: int, m: int, a: int, b: int) -> None:
        """
